...
const SidebarRes = ({
  ...
  return (
    <motion.div
      className={`sidebar_res ${isVisibleSidebar ? "" : "visible"}`}
      drag="y"
      onDragEnd={onDragEnd}
      initial="hidden"
      animate={controls}
    ...
    >
      <div className="sidebar_res-content">
        <div className="sidebar_res-header">
          <div className="dragedge">
            <div className="edge" />
          </div>
          <div className="btn">
            <button className="expand-btn" onClick={handleSidebar}>
              {isVisibleSidebar ? <IoChevronUpSharp /> : <IoChevronDownSharp />}
            </button>

...
import "./Header.css";
import logo from "../images/SocialGraphLogo3.svg";
import Provinces from "../data/provinces.json";
import { IoSearchSharp, IoFilterOutline, IoCloseSharp } from "react-icons/io5";
  ...
  return (
    <header className={`header ${showFilters ? "expanded" : ""}`}>
      <div className="header-content">
        ...
        >
          {showFilters ? <IoCloseSharp /> : <IoFilterOutline />}
        </div>
